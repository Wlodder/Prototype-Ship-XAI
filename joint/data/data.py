...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset == 'Military_Marvel':
...
def get_shared_loaders(args):
    return get_cars(True, os.environ['TRAIN_JANES_MARVEL_PATH'], 
                    os.environ['TRAIN_JANES_MARVEL_PATH'], os.environ['TEST_JANES_MARVEL_PATH'],
                      256, args.seed, 5)
