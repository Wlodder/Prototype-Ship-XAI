...
SUBJECT_DIR=${NET}_${EPOCHS_PRETRAIN}_${EPOCHS_TRAIN}_${NUM_FEATURES}_${BATCH_SIZE}_${BATCH_SIZE_PRETRAIN}_${IMAGE_SIZE}_${ALPHA}_CRP/${JANES_EXPERIMENT_DIRECTORY}/${K}_${BUFFER_SIZE}_${DROPOUT}_main
...
python $PIPNET_RUNDIR/main.py --dataset "Janes_Military_Marvel" --net $NET --batch_size $BATCH_SIZE\
  ...
  --buffer_type buffer:$BUFFER_SIZE --k $K --patch_size 32 --dropout $DROPOUT --weighted_loss --crp
