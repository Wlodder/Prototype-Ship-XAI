...
SUBJECT_DIR=${NET}_${EPOCHS_PRETRAIN}_${EPOCHS_TRAIN}_${NUM_FEATURES}_Janes
WEIGHTS_FILE=$1
...
python $PIPNET_RUNDIR/validate_prototypes.py --dataset "Janes_Military_Marvel" --net $NET --batch_size $BATCH_SIZE\
 ...
 --save_epoch_interval $SAVE_INTERVAL --eval_epoch_interval $EVAL_INTERVAL --visualize_epoch_interval 2 --state_dict_dir_net $NETDIR\
  --extra_test_image_folder $TEST_JANES_MARVEL_PATH\
