...
python $PIPNET_RUNDIR/main_memory_bank.py --dataset "Janes_Military_Marvel" --net $NET --batch_size $BATCH_SIZE\
 ...
 --buffer_type buffer:$BUFFER_SIZE --k $K --patch_size 32 --memory_size 1600
