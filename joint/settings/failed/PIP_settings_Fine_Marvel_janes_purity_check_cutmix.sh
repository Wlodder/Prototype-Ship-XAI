...
python $PIPNET_RUNDIR/purify_through_augmentation.py --dataset "Janes_Military_Marvel" --net $NET --batch_size $BATCH_SIZE\
 ...
 --buffer_type buffer:35 --k 45 --patch_size 48 --state_dict_dir_net $CHECKPOINT --debug
